...
$page_layout_meta = Konstic_Group_Fields_Value::page_layout('konstic');
$page_container_meta = Konstic_Group_Fields_Value::page_container('konstic','container_options');
...
if ('blank' == $page_layout_meta['layout']):
	...
	?>
    <div id="primary" class="content-area konstic-page-content-area padding-120 page-content-wrap-<?php the_ID(); ?> <?php echo esc_attr($full_width_class);?>">
