...
<?php
 ...
 $header_2_privacy_repeater = cs_get_option('header_2_privacy_repeater');
...
<div class="header-section-2">
    <div class="container-fluid">
        ...
        <div class="header-top-wrapper-2">
            <?php
                if ( $header_2_top_bar_contacts_repeater ) {
            ...
            <div class="top-right">
                <?php
                if ( $header_2_privacy_repeater ) {
                    echo '<ul class="text-list">';
                        foreach ( $header_2_privacy_repeater as $item ) {
                            echo '<li>';
                            if ( isset( $item['header_2_privacy_title'] ) ) {
                                echo '<a href="'. esc_url( $item['header_2_privacy_url'] ) .'" class="link">' . esc_html( $item['header_2_privacy_title'] ) . '</a>';
                            }
                            echo '</li>';
                        }
                        echo '</ul>';
                ...
                <div class="social-icon d-flex align-items-center">
                   <?php  
                    if ( $header_2_top_bar_socials_repeater ) {
                            foreach ( $header_2_top_bar_socials_repeater as $item ) {
                                if ( isset( $item['header_2_top_bar_socials_icon'] ) && isset( $item['header_2_top_bar_socials_url'] ) ) {
                                    echo '<a href="' . esc_url( $item['header_2_top_bar_socials_url'] ) . '">';
                ...
                <div class="header-main">
                    ...
                    <div class="header-right d-flex justify-content-end align-items-center">
                        ...
                        <div class="header-button">
                            <a href="<?php echo esc_url($header_2_right_btn_url); ?>" class="theme-btn"><?php echo esc_html($header_2_right_btn_text); ?> <i class="fa-regular fa-arrow-right"></i></a>
                        </div>
                        <?php 
                        endif; ?>
